...
# LOBBY
    def intermedio():
        ...
        btnTablaResultados= tk.Button(
            winVentana3, text="SIMULACIÓN TORNEO", bg="#926359", fg="#FFFFFF")
...
def estadisticasTablas():  
    ...
    for fila in range(len(puntoEquipo)):
        ...
        if totalPuntosAFavor == 0 and totalPuntosEnContra == 0:
            estadoPartido = False
        partidosJugados= partidosJugados/2
        ...
        listaPorEquipo.append(partidosJugados)
...
# TABLA DE RESULTADOS
    ...
    btnResultados.bind("<Button-1>", cantidadEquiposAFinal)
    btnIniciar = tk.Button( text="SIMULACIÓN", bg="#926359", fg="#FFFFFF")
    btnIniciar.place(x=150, y=300)
